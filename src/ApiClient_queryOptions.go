...
type PostQueryOption func(opts *postQueryOptions)
...
var (
	...
	PostWithContext = func(ctx context.Context) PostQueryOption {
		return func(opts *postQueryOptions) {
			opts.ctx = ctx
		}
	}
)
...
func makeListOpts(...map[string]string) *listQueryOptions {
